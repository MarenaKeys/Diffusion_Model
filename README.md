...
1. The model that is finetuned based on cat images is available via [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/MarenaKeys/Diffusion_Model/blob/main/Fast_DreamBooth_(Cats).ipynb)
